...
export default function Header(props) {
  ...
  return (
    <header className='flex w-full p-2 px-8 items-center z-10 bg-white shadow pb-4 sticky top-0'>
        <div className='title'>
            <h2 className='text-xl font-semibold'>{props.title}</h2>
        </div>
        <div className=' flex gap-1 items-center relative left-[30%]'>
            <div className='search rounded-full pr-3 pl-2 border-[1.6px] border-slate-500 flex items-center'>
        ...
        <div className='profile flex items-center absolute right-8 gap-2 cursor-pointer'>
